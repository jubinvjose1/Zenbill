...
interface SuperAdminActivityLogViewProps {
  activities: Activity[];
}

const SuperAdminActivityLogView: React.FC<SuperAdminActivityLogViewProps> = ({ activities }) => {
  return (
    <div>
      <h1 className="text-3xl font-bold text-on-surface mb-6">Super Admin Activity Log</h1>
      <Card>
        {activities.length > 0 ? (
          ...
          <div className="text-center py-16">
            ...
            <p className="mt-2 text-on-surface-secondary">
              Any administrative actions you take will be logged here.
            </p>
          </div>
        )}
      </Card>
...
export default SuperAdminActivityLogView;